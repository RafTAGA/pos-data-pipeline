...
--RESTART MarginEdge marginedge_orders
DROP TABLE IF EXISTS marginedge_orders;
...
--RESTART MarginEdge marginedge_line_items
DROP TABLE IF EXISTS marginedge_line_items;
...
--RESTART MarginEdge catalog_vendors
DROP TABLE IF EXISTS catalog_vendors;
...
--RESTART MarginEdge catalog_purchase_categories
DROP TABLE IF EXISTS catalog_purchase_categories;
...
--RESTART Toast catalog_revenue_centers
DROP TABLE IF EXISTS catalog_revenue_centers;
...
--RESTART Toast catalog_menu_items
DROP TABLE IF EXISTS catalog_menu_items;
...
--RESTART Toast catalog_sales_categories
DROP TABLE IF EXISTS catalog_sales_categories;
CREATE TABLE catalog_sales_categories (
    sales_category_guid  TEXT,
    category              TEXT
);

--RESTART Toast catalog_tables
...
--RESTART Toast catalog_dining_options
DROP TABLE IF EXISTS catalog_dining_options;
...
--RESTART Toast refunds_daily_summary
DROP TABLE IF EXISTS refunds_daily_summary;
...
--RESTART Toast labor_time_entries
...
--RESTART Toast toast_order_checks
DROP TABLE IF EXISTS toast_order_checks;
...
-- ________________________ EMPTY A TABLE ________________________________________________________________________
TRUNCATE TABLE toast_order_checks;
...
--RESTART Toast daily_sales_summary
...
-- RESTART Toast hourly_sales_view
...
DROP VIEW IF EXISTS hourly_sales_view;
CREATE VIEW hourly_sales_view AS
--TEMPORARY TABLE of Valid orders
WITH valid_orders AS (
...
-- RESTART Toast monthly_sales_summary
